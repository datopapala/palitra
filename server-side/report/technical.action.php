...
if($_REQUEST['act'] =='answear_dialog_table'){
	...
	$rResult = mysql_query("SELECT 	cdr.calldate,
									...
									CONCAT('<p onclick=play(', '\'', SUBSTRING(cdr.userfield, 35),'.wav', '\'',  ')>მოსმენა</p>', '<a download=\"image.jpg\" href=\"http://109.234.117.182:8181/records/', SUBSTRING(cdr.userfield, 35),'.wav', '\">ჩამოტვირთვა</a>') AS `dwn`
							FROM 	queue_stats
