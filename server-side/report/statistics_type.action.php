...
$text[1] 	= "შემოსული '$type' ზარები ქვე-განყოფილებების  მიხედვით";
$text[2] 	= "'$departament' შემოსული '$type' ზარები კატეგორიების მიხედვით";
$text[3] 	= "'$departament' შემოსული  '$type' ზარები ქვე-კატეგორიების მიხედვით";
//–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
