...
$ress = mysql_query("	SELECT 	COUNT(*) AS `unanswer_call`,
	...
	$dat .= '
						<ss:Row>
							...
							<ss:Cell>
								<ss:Data ss:Type="String">'.$row[answer_count].'</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.$row[call_answer_pr].' %</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.$roww[unanswer_call].'</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.$roww[call_unanswer_pr].' %</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.$row[avg_durat].' წუთი</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.$row[avg_hold].' წამი</ss:Data>
							</ss:Cell>
							<ss:Cell>
