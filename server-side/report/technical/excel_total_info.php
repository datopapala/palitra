	...
	$dat .= '
						<ss:Row>
							<ss:Cell ss:StyleID="headercell">
								<ss:Data ss:Type="String">ნაპასუხები ზარების რაოდენობა</ss:Data>
							</ss:Cell>
							<ss:Cell>
						...
						<ss:Row>
							<ss:Cell ss:StyleID="headercell">
								<ss:Data ss:Type="String">ოპერატორი შევიდა</ss:Data>
							</ss:Cell>
							<ss:Cell>
						...
						<ss:Row>
							<ss:Cell ss:StyleID="headercell">
								<ss:Data ss:Type="String">ოპერატორი გავიდა</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">0</ss:Data>
							</ss:Cell>
