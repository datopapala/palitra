...
$row_answer = mysql_fetch_assoc(mysql_query("	SELECT	COUNT(*) AS `count`,
	...
	$dat .= '
						<ss:Row>
							<ss:Cell>
								<ss:Data ss:Type="String">ზარი</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.($row_answer[count] + $row_abadon[count]).'</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.$row_answer[count].'</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.$row_abadon[count].'</ss:Data>
							</ss:Cell>							
							<ss:Cell>
								<ss:Data ss:Type="String">'.$row_done_blank[count].'</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.round(((($row_answer[count]) / ($row_answer[count] + $row_abadon[count])) * 100),2).' %</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.round(((($row_abadon[count]) / ($row_answer[count] + $row_abadon[count])) * 100),2).' %</ss:Data>
							</ss:Cell>
							<ss:Cell>
								<ss:Data ss:Type="String">'.round(((($row_done_blank[count]) / ($row_answer[count])) * 100),2).' %</ss:Data>
							</ss:Cell>
						</ss:Row>';
	$name = "ტექნიკური ინფორმაცია";
	...
	<ss:Worksheet ss:Name="'.$name.'">
		...
		<ss:Table x:FullRows="1" x:FullColumns="1" ss:ExpandedColumnCount="8" ss:ExpandedRowCount="3">
			...
			<ss:Row ss:AutoFitHeight="1" ss:Height="100">
				...
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">დამუშავებული </ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">ნაპასუხებია</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">უპასუხოა</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
				<ss:Cell ss:StyleID="headercell">
					<ss:Data ss:Type="String">დამუშავებულია</ss:Data>
					<ss:NamedCell ss:Name="Print_Titles" />
				</ss:Cell>
			</ss:Row>
